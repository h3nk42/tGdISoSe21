...
\renewcommand*{\maketitle}{
	\begin{titlepage}
		...
		\begin{center}
			...
			{\Large \@title\par}
			\vskip 0.5cm
			{\large \bfseries Ausarbeitung \par}
			\vskip 0.5cm
		...
		%	\vskip 0.5cm
			...
			\vskip 0.0cm
			{\large Gesellschaftliche Aspekte der Informatik}
			\vskip 0.0cm
			...
			\begin{flushleft}
				...
				\\
					Eingereicht von: &Niels von Borck 0575701, Mohamed Neji Ghazouani 0579181, \\  &Samuel Schrader 0562135, Henk van der Sloot 577448 \\ 
